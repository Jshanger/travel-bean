...
const styles = StyleSheet.create({
  ...
  howCard: { marginHorizontal: 20, borderWidth: 1, borderColor: BORDER, borderRadius: 18, backgroundColor: CARD, padding: 16, marginBottom: 14 },
  ...
  stepIcon: { width: 50, height: 50, borderRadius: 25, borderWidth: 1, borderColor: '#E2BE9F', backgroundColor: '#FFF7EA', alignItems: 'center', justifyContent: 'center', marginBottom: 7 },
  stepLabel: { color: INK, fontSize: 13, fontFamily: 'Inter_600SemiBold', textAlign: 'center' },
  dash: { width: 34, borderTopWidth: 2, borderStyle: 'dashed', borderColor: '#D6A98F' },
